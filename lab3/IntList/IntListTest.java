...
public class IntListTest {
    ...
    public void testReverse() {
        ...
        IntList rl1 = IntList.of(3, 2, 1);
        l1 = IntList.reverse(l1);
        assertEquals(l1, rl1);
        assertNotEquals(IntList.of(1, 2, 3), l1);

        IntList l2 = null;
        l2 = IntList.reverse(l2);
        assertNull(l2);

        IntList l3 = IntList.of(4, 5, 6, 5, 4);
        l3 = IntList.reverse(l3);
        assertEquals(IntList.of(4, 5, 6, 5, 4), l3);
    }
